...
Releases here are beta builds. They carry new features before those reach a stable release, and they are less tested: expect rough edges, and now and then something broken. If you just want Barberfish, the green stable badge above takes you to the regular release.

## Install

1. On your phone, tap the orange download badge above.
2. Sideload the APK:
